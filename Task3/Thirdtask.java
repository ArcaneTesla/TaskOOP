public class Thirdtask {
        ...
        public static void main(String[] args) {
            ...
            int [] q = {1, 0, 4, 5, 2, 4, 1, 2, 3, 3, 3, 5, 7, 9,9,9};
        ...
        // Задание 1
        // Учитывая массивы городов и населения, верните население округлено до ближайшего миллиона.
        ...
        public static String otherSides(double a){
            //гипотенуза 2a, вторая сторонa * корень из 3
            return "Средняя сторона = " + a * Math.sqrt(3) + " Длинная сторона = " + a * 2;
        }
        ...
        public static String inatorInator(String str){
            ...
            if (l=='a' || l=='e'|| l=='i' || l=='o' || l=='u' || l=='y')
                return str + "-inator " + chars.length + "000";
        ...
        public static double totalDistance(double top, double ras, int chel, boolean con){
            ras+=ras*chel/20;
            if(con)
                ras+=ras/10;
            return top*100/ras;
